...
private:
  ...
  std::shared_ptr<rclcpp::Subscription<geometry_msgs::msg::PoseStamped>> mRobotCpSubscription;
  std::shared_ptr<rclcpp::Publisher<geometry_msgs::msg::PoseStamped>> mRobotCpPublisher;
  std::shared_ptr<rclcpp::Publisher<geometry_msgs::msg::WrenchStamped>> mRobotServoPublisher;
  void JointStateCallback(const std::shared_ptr<sensor_msgs::msg::JointState> msg);
  void RobotCpCallback(const std::shared_ptr<geometry_msgs::msg::PoseStamped> msg);
  void RobotCpPubCallback(const std::shared_ptr<geometry_msgs::msg::PoseStamped> msg);
